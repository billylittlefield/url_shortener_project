...
ActiveRecord::Schema.define(version: 20150909222143) do
  ...
  add_index "visits", ["visitor_id", "short_url_id"], name: "index_visits_on_visitor_id_and_short_url_id", using: :btree
